...
public class BinaryTreePartThree {
    ...
    public static boolean getPath(Node root, int n, ArrayList<Node> path) {
        ...
        path.remove(path.size() - 1); //if not found for left and right child it means it will no be 
        //be the part of path so remove it 
        return false;
    }

    //find LCA - lowest common ancestor solution one
